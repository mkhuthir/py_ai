...
known_image = face_recognition.load_image_file("./people/test_face.jpg")
...
for image_path in Path("people").glob("*.png"):
    ...
    print("Checking: ", image_path, "Distance: ", face_distance)
...
print("Best Face Distance:",best_face_distance)
